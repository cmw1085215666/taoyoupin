...
import com.taoyoupin.pojo.TbTypeTemplateExample.Criteria;
import com.taoyoupin.sellergoods.service.TypeTemplateService;
...
public class TypeTemplateServiceImpl implements TypeTemplateService {
	...
	public List<Map> findSpecList(Long id) {
		...
		for(Map map:list){
			...
			com.taoyoupin.pojo.TbSpecificationOptionExample.Criteria criteria = example.createCriteria();
